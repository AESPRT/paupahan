...
import { STATS } from "./HeroSectionContent";
...
export function HeroSection() {
    ...
    return (
        <section className="relative min-h-[90vh] lg:min-h-[85vh] flex flex-col justify-center overflow-hidden bg-[#153730] pt-20 pb-24 lg:pt-28 lg:pb-32">
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full my-auto">
                ...
                <div className="text-center max-w-4xl mx-auto mb-8">
                    ...
                    <p className="mt-6 text-base sm:text-lg lg:text-xl text-[#FAF7EF]/90 max-w-2xl mx-auto font-normal leading-relaxed drop-shadow">
                        Daan-daang beripikadong paupahan sa buong bansa. Direktang kausap ang may-ari, walang hassle, walang hidden fees.
                    </p>
                ...
                <div className="mt-12 pt-8 border-t border-white/10 max-w-4xl mx-auto grid grid-cols-3 gap-4 text-center">
                    {STATS.map((stat, i) => (
                        <div key={i} className="flex flex-col items-center justify-center">
                            <div className="font-display text-2xl sm:text-3xl lg:text-4xl font-black text-white drop-shadow">
                                {stat.value}
                            </div>
                            <div className="text-xs sm:text-sm font-medium text-[#FAF7EF]/80 mt-1">{stat.label}</div>
                        </div>
                    ))}
                </div>
            ...
            <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-10 hidden sm:flex flex-col items-center text-white/60 animate-bounce cursor-pointer" onClick={scrollToContent}>
                <span className="text-[10px] uppercase tracking-widest font-semibold mb-1">Mag-scroll</span>
